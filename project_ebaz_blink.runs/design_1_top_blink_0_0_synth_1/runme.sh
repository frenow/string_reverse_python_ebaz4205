...
HD_PWD='C:/Users/Emerson/Documents/fpga/project_ebaz_blink/project_ebaz_blink.runs/design_1_top_blink_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_top_blink_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_top_blink_0_0.tcl
