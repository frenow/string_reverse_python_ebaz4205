...
proc create_root_design { parentCell } {
  ...
  # Create instance: top_blink_0, and set properties
  set block_name top_blink
  set block_cell_name top_blink_0
  if { [catch {set top_blink_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $top_blink_0 eq "" } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports FCLK_CLK0_0] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins top_blink_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins top_blink_0/rst_n]
  connect_bd_net -net top_blink_0_led_green [get_bd_ports led_green_0] [get_bd_pins top_blink_0/led_green]
  connect_bd_net -net top_blink_0_led_red [get_bd_ports led_red_0] [get_bd_pins top_blink_0/led_red]
  connect_bd_net -net top_blink_0_uart_tx [get_bd_ports uart_tx_0] [get_bd_pins top_blink_0/uart_tx]
  connect_bd_net -net uart_rx_0_1 [get_bd_ports uart_rx_0] [get_bd_pins top_blink_0/uart_rx]
